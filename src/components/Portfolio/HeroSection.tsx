        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-6">
              <h1 className="text-6xl lg:text-7xl font-playfair font-bold mb-4">
                <span className="gradient-text">Ditya</span>
                <br />
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              {/* Floating decoration */}
              <div className="absolute -top-4 -right-4 w-12 h-12 bg-accent rounded-full shadow-elegant float" style={{ animationDelay: '1.5s' }}></div>
              <div className="absolute -bottom-6 -left-6 w-8 h-8 bg-success rounded-full shadow-elegant float" style={{ animationDelay: '2.5s' }}></div>
            </div>
          </div>
        </div>
      </div>
